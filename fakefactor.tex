...
\begin{figure}[h!]
 \centering
 \includegraphics[width=0.49\columnwidth]{/Users/sheenaschier/Documents/LaFiles/figures/thesis/fakes/WjetsXsec}
  \includegraphics[width=0.49\textwidth]{/Users/sheenaschier/Documents/LaFiles/figures/thesis/theory/SUSYx-sec.png}
...
\end{figure}
 ...
 \section{Conclusion}
 \label{sec:FFcon}
Fake leptons primarily arise from $W(\rightarrow\ell\nu)$+jets events and.provide the largest contribution to signals with two-soft-lepton and intermediate \met.  These backgrounds are estimated with a data driven fake factor method with measured fake factors binned in lepton \pt and and muon fake factors further separated in $N_{b-\mathrm{jets}}$.  Fake background estimates in the signal regions are validated in a same-sign validation region show good agreement with data.  Fake factors were of order 0.2 with relative uncertainties $30-50\%$.  The contribution to the total fake backgrounds from events with double fakes is very small

\textcolor{red}{Table summarizing fake factors?  Also, state a range of uncertainties?
