...
\label{sec:sr:mll}
\textcolor{red}{Talk about the three extra cuts that make the Higgsino SR, then introduce the inclusive and exclusive signal regions defined by $m_{\ell\ell}$}
 \begin{table}[]
 \tiny
\centering
\resizebox{\linewidth}{!}{
